...
<div class="panel panel-sas">
    <div class="panel-heading"><h2>Upcoming Enhancements</h2></div>
    <div class="panel-body">
    <div class="row">
        <div class="col-sm-6">
            <h3>Features</h3>
            <ul>
                <li>Search by location (address, zip code, etc.)</li>
                <li>Search by specific sacrament or devotion</li>
                <li>Search by any date, not just the current week</li>
                <li>
                    Expand to the entire Capital District (Albany, Rensselaer,
                    Saratoga and Schenectedy counties)
                </li>
                <li>Expand to the entire Diocese of Albany</li>
            </ul>
        </div>
        <div class="col-sm-6">
            <h3>Technical</h3>
